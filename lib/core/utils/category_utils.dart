...
class CategoryUtils {
  static const List<String> shoeKeywords = [
    'shoe', 'sneaker', 'cleat', 'boot', 'footwear', 'sandal', 'slide', 'flip'
  ];

  static const List<String> clothingKeywords = [
    'shirt', 't-shirt', 'tee', 'jersey', 'polo', 'tank', 'top', 
    'short', 'pant', 'legging', 'trouser', 'tight', 'jogger', 
    'hoodie', 'sweatshirt', 'pullover', 'fleece', 
    'jacket', 'gilet', 'windbreaker', 'anorak', 'vest', 'sock'
  ];
  ...
  static bool isShoes(ProductEntity product) {
    ...
    if (cat.contains('shoe') || cat.contains('sandal') || cat.contains('slide')) return true;
