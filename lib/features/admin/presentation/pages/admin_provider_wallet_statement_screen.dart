...
/// Admin xem sao kê ví của 1 chủ sân (audit / giải thích vì sao ví âm).
class AdminProviderWalletStatementScreen extends StatefulWidget {
  final AdminStatisticsDatasource datasource;
  final String providerId;
  final String providerName;
  const AdminProviderWalletStatementScreen({
    super.key,
  ...
  @override
  State<AdminProviderWalletStatementScreen> createState() =>
      _AdminProviderWalletStatementScreenState();
}

class _AdminProviderWalletStatementScreenState
    extends State<AdminProviderWalletStatementScreen> {
  bool _loading = true;
  String? _error;
  ...
  Future<void> _load() async {
    ...
    try {
      final txns = await widget.datasource.getProviderWalletTransactions(widget.providerId);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Sao kê ví — ${widget.providerName}',
